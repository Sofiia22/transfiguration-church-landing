...
const translations = {
  ...
  uk: {
    ...
    about:
      "Ми — любляча церковна родина, яка прагне пізнавати Бога, служити людям і ділитися надією Ісуса Христа. Ми раді кожному.",
  ...
  ru: {
    ...
    about:
      "Мы — любящая церковная семья, стремящаяся познавать Бога, служить людям и делиться надеждой Иисуса Христа. Мы рады каждому.",
